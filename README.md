...
```bat
msedge --app="https://gy-creative.vercel.app/s"
```
...
- Audience / Zoom 공유용: `https://gy-creative.vercel.app/s`
- 진행자 콘솔 / Audience 따라가기 전용: `https://gy-creative.vercel.app/c`
- 학생용 대본 보기 / 자유 이동 가능: `https://gy-creative.vercel.app/vc`
...
Vercel은 정적 사이트로 배포하며, production alias는 `https://gy-creative.vercel.app`입니다. Netlify 배포 설정은 기존 호환을 위해 유지합니다.
