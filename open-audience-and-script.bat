...
start "Audience" "%EDGE%" --no-first-run --user-data-dir="%BASE%\audience" --app="http://127.0.0.1:4183/index.html?present=1&v=%STAMP%#/1"
timeout /t 1 /nobreak >nul
start "Speaker Console" "%EDGE%" --no-first-run --user-data-dir="%BASE%\speaker" --app="http://127.0.0.1:4183/index.html?present=1&script=1&local=1&v=%STAMP%#/1"
